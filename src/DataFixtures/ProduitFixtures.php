...
class ProduitFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $product1->setImage('vinyles-e-commerce\public\uploads\produits\douaa.jpg');
        $product1->setStock(3);
        ...
        $product2->setImage('vinyles-e-commerce\public\uploads\produits\mj.jpg');
        $product2->setStock(5);
        ...
        $product3->setImage('vinyles-e-commerce\public\uploads\produits\met.jpg');
        $product3->setStock(7);
